...
<div align="center"> 
  ...
  <br>
  <em>Representation of the TapeStation analysis of a successful ATAC-seq experiment.</em>
</div>
...
Because Tn5 dimerizes when it cuts the DNA, the two Tn5 molecules are offset by 9 base pairs. Reads aligned to the + strand are shifted +4 bp and those on the – strand are shifted –5 bp. Therefore, in some specific scenarios such as TF footprinting, ATAC-seq requires correction of read positions to represent the true cut sites. The computational handling of this shift is reviewed in the [following section](./05_ATAC-seq_analysis.md).
