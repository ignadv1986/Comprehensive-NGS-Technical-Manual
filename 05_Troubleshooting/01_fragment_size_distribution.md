...
- **DNA/RNA degradation:** Poor sample handling before and during library prep can lead to genome degradation, leading to a a very wide peak that sometimes fuses with the adapter dimer peak, and the virtual gel shows a smeary signal.
